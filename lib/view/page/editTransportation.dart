...
class EditTransportation extends StatefulWidget {
  int id_customer, idTransportation;
...
class _EditTransportationState extends State<EditTransportation> {
  ...
  void dataEdit() {
    tipeKendaraan.text = widget.tipeKendaraan;
    lama_penggunaan.text =
        widget.lamaPenggunaan.replaceAll(RegExp(r'[^0-9]'), '');
    jumlah_unit.text = widget.jmlUnit;
    dateTime = DateTime.parse(widget.tanggalPenggunaan);
    hargaC.text = currencyFormatter
        .format(double.parse(widget.harga))
        .replaceAll('.', ',');
    tujuan_kendaraan.text = widget.tujuanKendaraan;
  }
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ButtonStyle(
                  ...
                  overlayColor: MaterialStateProperty.all(Color(0xFF48A9F8)),
